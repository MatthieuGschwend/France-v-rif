...
def app():
    ...
    with st.beta_expander("Time (in second) distribution of the main function"):
    ...
    with st.beta_expander("Time (in second) distribution of the diffbot function and old scraper function"):
    ...
    with st.beta_expander("Time (in second) distribution of each function that compose old scraper function"):
    ...
    with st.beta_expander("Time (in second) distribution of the replicas collector functions"):
    ...
    with st.beta_expander("Time (in second) distribution of the google image classification function"):
